import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.CScuXPqu.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"notebook/es6/Class.md","filePath":"notebook/es6/Class.md"}'),l={name:"notebook/es6/Class.md"},e=p(`<h2 id="class-的基本语法" tabindex="-1">Class 的基本语法 <a class="header-anchor" href="#class-的基本语法" aria-label="Permalink to &quot;Class 的基本语法&quot;">​</a></h2><h3 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h3><ul><li>ES6 的 class 可以看作只是一个语法糖，它的绝大部分功能，ES5 都可以做到</li><li>定义类方法的时候前面不需要加 function 关键字，且方法之间不用加都好分隔</li><li>类的数据类型就是函数，类本身就是指向构造函数</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>class Point {</span></span>
