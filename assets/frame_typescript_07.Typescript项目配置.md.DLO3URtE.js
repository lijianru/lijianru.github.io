import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.CScuXPqu.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frame/typescript/07.Typescript项目配置.md","filePath":"frame/typescript/07.Typescript项目配置.md"}'),e={name:"frame/typescript/07.Typescript项目配置.md"},t=p(`<h2 id="编译的上下文" tabindex="-1">编译的上下文 <a class="header-anchor" href="#编译的上下文" aria-label="Permalink to &quot;编译的上下文&quot;">​</a></h2><blockquote><p>使用 tsconfig.json 文件定义编译的上下文。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>{</span></span>
