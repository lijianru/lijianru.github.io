import{_ as n,c as a,o as e,ag as p}from"./chunks/framework.S-Qvb3wi.js";const f=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frame/react/11.Hooks.md","filePath":"frame/react/11.Hooks.md"}'),t={name:"frame/react/11.Hooks.md"};function l(i,s,c,o,u,r){return e(),a("div",null,s[0]||(s[0]=[p(`<h2 id="usesate" tabindex="-1">useSate() <a class="header-anchor" href="#usesate" aria-label="Permalink to &quot;useSate()&quot;">​</a></h2><p>返回一个 state 和更新 state 的函数</p><ul><li><p>在初始渲染阶段，返回的 state 和传入 useState 的参数一致</p></li><li><p>如果新的 state 需要通过前一次的 state 计算得出，那么可以将函数传递给 setState 函数</p></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;button onClick={() =&gt; setCount(prevCount =&gt; prevCount - 1)}&gt;-&lt;/button&gt;</span></span></code></pre></div><ul><li>如果初始化 state 需要经过复杂的计算的出则可以使用惰性初始化</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// bad</span></span>
...
<span class="line"><span>    &lt;/&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li>获取上一次渲染的 state</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export function PrevState() {</span></span>
...
<span class="line"><span>    &lt;/div&gt;</span></span>
<span class="line"><span>  )</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li>保存句柄</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export function ClearInterval() {</span></span>
<span class="line"><span>  const [count, setCount] = useState(0)</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,28)]))}const h=n(t,[["render",l]]);export{f as __pageData,h as default};
