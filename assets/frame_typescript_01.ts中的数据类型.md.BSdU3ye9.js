import{_ as n,c as s,o as a,a3 as p}from"./chunks/framework.CScuXPqu.js";const f=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frame/typescript/01.ts中的数据类型.md","filePath":"frame/typescript/01.ts中的数据类型.md"}'),l={name:"frame/typescript/01.ts中的数据类型.md"},e=p(`<h2 id="基本数据类型" tabindex="-1">基本数据类型 <a class="header-anchor" href="#基本数据类型" aria-label="Permalink to &quot;基本数据类型&quot;">​</a></h2><blockquote><p>TypeScript 支持与 JavaScript 几乎相同的数据类型，此外还提供了枚举类型</p></blockquote><ul><li>布尔值</li><li>数字</li><li>字符串</li><li>数组（数组内元素类型相同）</li><li>元组（元组内元素类型可以不相同） <ul><li>访问一个已知元素会得到正确的类型</li><li>访问越界元素会报错（高版本）</li></ul></li><li>枚举（默认情况下元素编号从 0 开始，可以手动指定编号）</li><li>null</li><li>undefined</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 布尔值 boolean</span></span>
