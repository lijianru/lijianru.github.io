import{_ as s,c as a,o as p,ag as l}from"./chunks/framework.S-Qvb3wi.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"frame/typescript/01.ts中的数据类型.md","filePath":"frame/typescript/01.ts中的数据类型.md"}'),e={name:"frame/typescript/01.ts中的数据类型.md"};function i(c,n,t,o,r,u){return p(),a("div",null,n[0]||(n[0]=[l(`<h2 id="基本数据类型" tabindex="-1">基本数据类型 <a class="header-anchor" href="#基本数据类型" aria-label="Permalink to &quot;基本数据类型&quot;">​</a></h2><blockquote><p>TypeScript 支持与 JavaScript 几乎相同的数据类型，此外还提供了枚举类型</p></blockquote><ul><li>布尔值</li><li>数字</li><li>字符串</li><li>数组（数组内元素类型相同）</li><li>元组（元组内元素类型可以不相同） <ul><li>访问一个已知元素会得到正确的类型</li><li>访问越界元素会报错（高版本）</li></ul></li><li>枚举（默认情况下元素编号从 0 开始，可以手动指定编号）</li><li>null</li><li>undefined</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 布尔值 boolean</span></span>
...
<span class="line"><span>obj = []</span></span>
<span class="line"><span>obj = Color</span></span></code></pre></div><blockquote><p>注：TypeScript 的原始类型写为 boolean、number、string 等等，在 JavaScript 中都有类似的关键字 Boolean、Number、String。 后者是 JavaScript 中的构造函数，而 Typescript 中 number 仅仅便是类型。</p></blockquote>`,5)]))}const m=s(e,[["render",i]]);export{b as __pageData,m as default};
